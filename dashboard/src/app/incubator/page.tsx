...
export default function IncubatorPage() {
  ...
  useEffect(() => {
    ...
    const defaultDrafts = [
      { id: '1', title: "Autonomous Debugger", progress: 65, desc: "Self-healing code engine using real-time LSP analysis and backpropagation.", tags: ["PYTHON", "LSP"], difficulty: "EXTREME", status: 'DRAFT' as const, version: "1.0.0", notes: "SYSTEM LOG:\n- Init draft\n- Running compilation checks." },
      { id: '2', title: "Neural Memory Graph", progress: 40, desc: "Local knowledge graph that tracks entity relationships across conversation histories using a graph database.", tags: ["GRAPHDB", "RAG"], difficulty: "HIGH", status: 'DRAFT' as const, version: "1.0.0", notes: "SYSTEM LOG:\n- Registered sqlite parameters." },
      ...
      { id: '9', title: "Autonomous Journalist Command Center", progress: 0, desc: "A standalone Next.js dashboard orchestrating local LLMs, video generation, and Ghost CMS headless publishing.", tags: ["NEXTJS", "REACT", "OLLAMA", "GHOST"], difficulty: "HIGH", status: 'DRAFT' as const, version: "1.0.0", notes: "SESSION MILESTONES LOG:\n- Scaffolding NextJS client workspace views.\n- Integrated Sub-Cockpits filtering grid tabs inside sidebar layout.\n- Implemented live SSL redirect chains tracker inside SEO Auditor.\n- Built sitemaps detection and multi-threaded dead link crawler in Python.\n- Integrated client-side PDF Report generator using jsPDF exporter.\n- Compiled zero-error production build.\n- Spawned deployable Council Room war room route under COMMAND cockpit." }
    ];
